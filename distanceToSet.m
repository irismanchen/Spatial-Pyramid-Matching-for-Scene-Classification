...
% 	histograms: matrix containing T features from T training images - K * (4b@mins^(L+1) − 1 / 3) × T matrix
% Output:
% 	histInter: histogram intersection similarity between wordHist and each training sample as a 1 × T vector

	% TODO Implement your code here
	similarity = bsxfun(@min, histograms, repmat(wordHist, 1, size(histograms, 2)));
    histInter = sum(similarity);
end